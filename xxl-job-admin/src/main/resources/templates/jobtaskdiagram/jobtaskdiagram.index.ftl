...
<div class="wrapper">
    ...
    <!-- left -->
    <@netCommon.commonLeft "jobtaskdiagram" />

    <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        <!-- Content Header (Page header) -->
        <section class="content-header">
            <h1>${I18n.jobdiagram_name}</h1>
        </section>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-body">
                            <div id="diagram" style="height: 900px;"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<#-- node点击事件 -->
<div class="modal fade" id="jobOperateView" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" >${I18n.system_opt}
                    <span id="taskIdDisplay" ></span>
                </h4>
            </div>
            <div class="modal-body">
                <button type="button" class="btn btn-default" onclick="triggerTask()" data-dismiss="modal">${I18n.jobinfo_opt_run}</button>
                <button type="button" class="btn btn-default" onclick="viewLog()" data-dismiss="modal">${I18n.jobinfo_opt_log}</button>
                <button type="button" class="btn btn-default" onclick="jobNetTime()" data-dismiss="modal">${I18n.jobinfo_opt_next_time}</button>
                <button type="button" class="btn btn-default" onclick="editTask()" data-dismiss="modal">${I18n.system_opt_edit}</button>
                <button type="button" class="btn btn-default" id="runButton" style="display:none;" onclick="operateTask('job_resume')" data-dismiss="modal">${I18n.jobinfo_opt_start}</button>
                <button type="button" class="btn btn-default" id="stopButton" style="display:none;" onclick="operateTask('job_pause')" data-dismiss="modal">${I18n.jobinfo_opt_stop}</button>
                <button type="button" class="btn btn-default" id="delButton" onclick="operateTask('job_del')" data-dismiss="modal">${I18n.system_opt_del}</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">${I18n.system_cancel}</button>
...
<script src="${request.contextPath}/static/js/jobtaskdiagram.1.js"></script>
